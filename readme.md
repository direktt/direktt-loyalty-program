...
- **Award new loyalty points to users online or in-store:**
    ...
    1. User makes a purchase or presents coupon in-store. Salesperson scans user's memebership QR code and adds points to user's loyalty account using Direktt mobile app. Both user and admin receive automated message notification.
- **Users wants to redeem an award:**
    - Salesperson scans user's memebership QR code and verifies current loyalty balance. Salesperson issues an award and resets / removes respective number of points from user's loyalty account using Direktt mobile app. Both user and admin receive automated message notification
